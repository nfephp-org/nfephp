  ...
  <table width="70%" border="0" align="center">
    <tr>
      <td width="41%"><div align="center">
              <h2>Instala&ccedil;&atilde;o NFePHP 2.0</h2><p><i><?php echo 'vers&atilde;o do configurador '.$installVer;?></i></p>
        </div></td>
      <td width="14%">&nbsp;</td>
    ...
    <tr>
      <td colspan="3"><p>Esta rotina ir&aacute; verificar as condi&ccedil;&otilde;es
        ...
        <p> <em>ATENÇÃO: para utilizar a classe de envio de emails
      ...
      <td colspan="3"><form action="grava_config.php" method="post" name="formSave" id="formSave">
          <table width="90%" border="0" align="center">
            ...
            <tr>
              ...
              <td><?php echo $certVal;?></td>
            </tr>
            <tr>
              <td><div align="right">Senha da chave privada</div></td>
              <td><input name="keysenha" type="text" id="keysenha" value="<?php echo $keyPass;?>" size="20" maxlength="30"></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td><div align="right">Senha de Decripta&ccedil;ao</div></td>
              <td><input name="passe" type="text" id="passe" value="<?php echo $passPhrase;?>" size="20" maxlength="30"></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td><input name="password" type="text" id="password" value="<?php echo $mailPASS;?>" size="20" maxlength="30"></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td><div align="right">Protocolo</div></td>
              <td><input name="protocol" type="text" id="protocol" value="<?php echo $mailPROTOCOL;?>" size="20" maxlength="30"></td>
              <td><i>usar com PHPMailer</i></td>
            </tr>
            <tr>
              <td><div align="right">MailFromMail</div></td>
              <td><input name="mailtfrommail" type="text" id="mailfrommail" value="<?php echo $mailFROMmail;?>" size="20" maxlength="30"></td>
              <td><i>usar com PHPMailer</i></td>
            </tr>
            <tr>
