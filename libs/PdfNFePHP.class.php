...
class PdfNFePHP extends FPDF {
    ...
    private $ABCset="";                                        // jeu des caracteres ligibles au C128
    private $Aset="";                                          // Set A du jeu des caracteres ligibles
    private $Bset="";                                          // Set B du jeu des caracteres ligibles
    private $Cset="";                                          // Set C du jeu des caracteres ligibles
    ...
    private $JStart = array("A"=>103, "B"=>104, "C"=>105);     // Caracteres de selection de jeu au dabut du C128
    private $JSwap = array("A"=>101, "B"=>100, "C"=>99);       // Caracteres de changement de jeu
