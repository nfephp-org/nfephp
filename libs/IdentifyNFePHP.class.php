 ...
 *                adicionado algumas funções para verificar digito verificador de chave de acesso 
            ...
            if ($tmp_chave!==false) {
                ...
                if ($tmp_query['modelo']=='65') {
                    if ($tmp_url['scheme']!='https') {
                        // todos webservices do nfce são https, os demais é site pra baixa xml do emitente
                        return(false);
                    }
        ...
        public function identifyChave($chave)
        {
            ...
            if (strlen($chave_numeros)==44) {
                ...
                if (substr($chave_numeros, 20, 2)=='55' ||
                    ...
                    // verifica digito
                    if (!$this->calculadv(substr($chave_numeros, 0, 43))==substr($chave_numeros, 43, 1)) {
                        return(false);
                    }
